...
import static info.bitrich.xchangestream.binance.old.dto.BaseBinanceWebSocketTransaction.BinanceWebSocketTypes.TICKER_24_HR;
...
public class TickerBinanceWebsocketTransactionTest {
  ...
  public void test_deserialization_of_transaction_message() throws IOException {
    ...
    assertThat(tickerTransaction.getSymbol()).isEqualTo(CurrencyPair.ETH_BTC);
